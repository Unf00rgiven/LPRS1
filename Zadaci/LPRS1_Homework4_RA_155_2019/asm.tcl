...
set asm_file "LPRS1_Homework4_RA_155_2019_Solution/asm/dna_sequencer.asm"

###############################################################################

set assembler_dir "lprs1_assembler/"

set hdl_dir [file join [file dirname [file dirname $asm_file]] "hdl/"]
...
if {$result} {
	...
	insert_to_vhd $asm_bare.o.txt $hdl_dir/instr_rom.vhd \
		$ir_vhd_beg $ir_vhd_end
	insert_to_vhd $asm_bare.o.dat $hdl_dir/data_ram.vhd \
