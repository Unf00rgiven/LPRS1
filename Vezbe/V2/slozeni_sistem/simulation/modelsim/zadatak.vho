...
-- Equation(s):
-- \sMUX~1_combout\ = (\sMUX~0_combout\ & ((\iB[0]~input_o\) # ((\iB[1]~input_o\)))) # (!\sMUX~0_combout\ & (\iB[0]~input_o\ $ (((\sCOD[0]~3_combout\)))))
...
-- Equation(s):
-- \sADD_A[2]~0_combout\ = (\iA[6]~input_o\) # ((\iA[7]~input_o\) # ((\iA[5]~input_o\) # (\iA[4]~input_o\)))
...
-- Equation(s):
-- \sCOD[1]~1_combout\ = (\iA[6]~input_o\) # ((\iA[7]~input_o\) # (\sCOD[1]~0_combout\))
...
PORT MAP (
	dataa => \iA[6]~input_o\,
	datac => \iA[7]~input_o\,
	datad => \sCOD[1]~0_combout\,
	combout => \sCOD[1]~1_combout\);

-- Location: LCCOMB_X7_Y11_N24
\Add0~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Add0~0_combout\ = (\sCOD[1]~1_combout\ & ((\iB[1]~input_o\) # ((\iB[0]~input_o\ & \sCOD[0]~3_combout\)))) # (!\sCOD[1]~1_combout\ & (\iB[0]~input_o\ & (\iB[1]~input_o\ & \sCOD[0]~3_combout\)))
...
-- Equation(s):
-- \Add0~1_combout\ = \sADD_A[2]~0_combout\ $ (\iB[2]~input_o\ $ (\Add0~0_combout\))
...
-- Equation(s):
-- \Add0~2_combout\ = (\sADD_A[2]~0_combout\ & ((\iB[2]~input_o\) # (!\Add0~0_combout\))) # (!\sADD_A[2]~0_combout\ & (\iB[2]~input_o\ & !\Add0~0_combout\))
...
-- Equation(s):
-- \Add1~0_combout\ = \sCOD[1]~1_combout\ $ (\iB[1]~input_o\ $ (((\iB[0]~input_o\) # (\sCOD[0]~3_combout\))))
...
-- Equation(s):
-- \sMUX~6_combout\ = (\iB[0]~input_o\ & (\sCOD[0]~3_combout\ & (\sCOD[1]~1_combout\ $ (\iB[1]~input_o\)))) # (!\iB[0]~input_o\ & (!\sCOD[0]~3_combout\ & (\sCOD[1]~1_combout\ $ (!\iB[1]~input_o\))))
