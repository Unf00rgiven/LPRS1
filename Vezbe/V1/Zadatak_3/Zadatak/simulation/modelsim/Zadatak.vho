...
-- iB3	=>  Location: PIN_L2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- iB2	=>  Location: PIN_M4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- iB1	=>  Location: PIN_K1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- iB0	=>  Location: PIN_L3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL ww_iB2 : std_logic;
SIGNAL ww_iB3 : std_logic;
SIGNAL ww_oY : std_logic;
...
SIGNAL \ALT_INV_oY~0_combout\ : std_logic;
...
\ALT_INV_oY~0_combout\ <= NOT \oY~0_combout\;
...
-- Equation(s):
-- \oY~0_combout\ = (\iB1~input_o\ & (((\iB3~input_o\)))) # (!\iB1~input_o\ & (\iB2~input_o\ $ (((\iB0~input_o\ & !\iB3~input_o\)))))
