...
add wave -noupdate /top_tb/oMUX_ROW
add wave -noupdate /top_tb/oMUX_COLOR
add wave -noupdate /top_tb/onCOL
add wave -noupdate /top_tb/sRGB_MATRIX
add wave -noupdate -divider {Phase}
add wave -noupdate /top_tb/uut/cpu_top_i/cu_i/sSTATE
...
add wave -noupdate -divider {Phase Regs}
add wave -noupdate -radix unsigned /top_tb/uut/cpu_top_i/sA
add wave -noupdate -radix unsigned /top_tb/uut/cpu_top_i/sB
add wave -noupdate -radix unsigned /top_tb/uut/cpu_top_i/sC
...
add wave -noupdate -radix unsigned /top_tb/uut/i_data_ram/rMEM
add wave -noupdate -divider {IO Ctrl}
add wave -noupdate /top_tb/uut/i_rgb/sSYNC_MATRIX
add wave -noupdate /top_tb/uut/i_rgb/sHEARTBEAT
add wave -noupdate -radix unsigned /top_tb/uut/i_rgb/sBUS_MATRIX
add wave -noupdate -radix unsigned /top_tb/uut/i_rgb/sOUT_MATRIX
add wave -noupdate /top_tb/uut/i_pbd/sDIR
add wave -noupdate -radix decimal /top_tb/uut/i_pbd/sMOVE_X
add wave -noupdate -radix decimal /top_tb/uut/i_pbd/sMOVE_Y
